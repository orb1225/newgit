...
the ship up after getting into an escape pod.thons of Planet 
Percal #25 have invaded your ship and destroyed your entire crew. 
...
in the head putting him down,then jump through theWeapon Armory door.
...
where you must. place it in the right spot.You burst onto the Bridge 
with the netron destruct bomb under your arm and surprise 5 Gothons 
who are trying to take control of the ship.Each of them has an even 
uglier clown costume than the last.They haven't pulled their weapons 
out yet,as they see the active bomb under your arm and don't want to 
set it off.
""")
...
open it, and then carefully place the bomb on the floor, pointing 
...
that the bomb is placed you run to the escape pod to get off thistin can.
You rush through the ship desperately trying to make it to the escape pod 
before the whole ship explodes. It seems like hardly any Gothons are 
on the ship, so your run is clear of interference. You get to the chamber
with the escape pods, and now need to pick one to take. Some of them 
could be damaged but you don't have time to look. There's 5 pods, 
...
then explode like a bright star,taking out the Gothon ship at the same time. 
You won!
""")
